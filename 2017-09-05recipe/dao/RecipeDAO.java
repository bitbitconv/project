...
public class RecipeDAO {
	...
	public static List<Recipe> selectRecipe(){
		...
		public void upRecipe(Recipe recipe) {  // 등록
		...
		try {
			...
			stmt = con.prepareStatement(sql.toString());
			stmt.setString(1, recipe.getPhoto());
			stmt.executeUpdate();
	...
	public Recipe updateSelect(int no) {
		Connection con = null ;
		PreparedStatement stmt = null ;
...
//				re.setHits(rs.getInt("hits"));
//				re.setManage(rs.getString("manage"));
