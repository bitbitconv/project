...
public class SearchController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String reviewSearchList = dao.reviewSearch(keyword);
		System.out.println(reviewSearchList);
		...
		out.println("		border : 1px solid #444;" + " height : 40px   ");
		out.println("	}                             ");
		out.println("	table{                        ");
		...
		out.println("	</tr>");
		out.println("	<tr>");
		out.println("		<td>" + reviewSearchList + "</td>");
		out.println("	</tr>");
		out.println("	<tr>");
