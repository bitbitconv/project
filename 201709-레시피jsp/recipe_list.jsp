...
$(window).scroll(function() {
    if ($(window).scrollTop() == $(document).height() - $(window).height()) {
      console.log(++page);
      $("body").append('<div class="col-xs-6 col-md-4"><h1>Page ' + page + '</h1></div>');
...
<nav class="w3-sidebar w3-bar-block w3-card-2 w3-animate-left w3-center" style="display:none" id="mySidebar">
  ...
  <a href="/conv/jsp/recipe/recipe_list.jsp" class="w3-bar-item w3-button">혼밥 게시판!</a>
...
<div class="col-xs-6 col-md-4" width ="33%" float = "left" >
		 <button  name = "no" value ="${post.no}"><c:out value ="${post.no}"/> </button>
	 	 <c:out value="${post.id}"/><br> 
		 <img  src ="http://localhost:8000/conv/upload${post.photo}"><br>
