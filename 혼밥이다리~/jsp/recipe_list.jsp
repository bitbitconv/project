...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<header class="w3-container w3-theme w3-padding" id="myHeader">
		...
		<div class="w3-center">
			<h4 text-align = "center">펴니점 꿀정보 사이트</h4>
	...
	<div id="id01" class="w3-modal">
		<div class="w3-modal-content w3-card-4 w3-animate-top">
			...
			<footer class="w3-container w3-theme-l1">
				<p>
					<a class="w3-btn" href="/conv/jsp/recipe/recipe_list.jsp">요즘 인기상품 보러가봐!</a>
				</p>
			</footer>
		</div>
	</div>
...
<div class="w3-container">
  ...
  <div class="w3-center">
    <h2>혼밥 게시판</h2>
    <p w3-class="w3-large">각종 혼밥러들의 시크릿 레시피가 이곳에!</p>
  </div>
  <a href = "/conv/jsp/recipe/recipe_insert.jsp">
<button class="w3-btn w3-xlarge w3-blue w3-hover-white" style="font-weight:900;">글쓰기</button></a>
<p>
<div class="w3-responsive w3-card-4">
<tbody>
<div class="grid are-images-unloaded">
<form action ="/conv/conv/detail">	
    <c:forEach var ="post" items="${list}" >
	 <div class="w3-row-padding w3-third w3-margin-top">
	  <div class="col-xs-6 col-md-4" width ="33%" float = "left" >
	  
	 	 글번호 :<button class="w3-bar-item w3-button" name="no" value="<c:out value="${post.no}" />">
      	  		  <c:out value="${post.no}" />.
      		</button></td>
	     <c:out value="${post.id}"/><br> 
		 <img  width = "350" height="350" src ="http://localhost:8000/conv/upload${post.photo}"><br>
	 	 제목: <c:out value="${post.title}"/><br>
	 	 내용: ${post.content}<br>
 		</div>
 	 </div>
 	</c:forEach>  
