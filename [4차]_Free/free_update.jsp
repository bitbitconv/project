...
<%--페이스북 로그인 api --%>
    ...
    <h2>나눔 게시글 수정</h2>
  	<br>
	<form action="${pageContext.request.contextPath}/free/update">
		상태&nbsp;&nbsp;
		...
		<p>제목</p>
			<input class="w3-input w3-hover-light-grey" name="title"
				   value="<%= post.getTitle() %>" required>
		<p>내용</p>
			<textarea class="w3-input" name="content" required>
		...
		<a href="/conv/free/list">
			<button class="w3-button w3-large w3-blue"
					style="font-weight:900; width:20%" name="no" value="${ post.no }">목록으로</button></a>
		<button class="w3-button w3-large w3-blue w3-right"
				style="font-weight:900; width:20%" name="no" value="${ post.no }">게시글 수정</button>
	</form></div><br>
