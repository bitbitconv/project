...
<div class="w3-card white">
  ...
  <div class="w3-container w3-theme w3-card-2">
    <h3><c:out value="${ post.title }" />( ${ post.state })</h3>
  </div>
  <div class="w3-container">
  ...
  <ul class="w3-ul w3-border">
    <li>
      <p><fmt:formatDate value="${ post.regDate }" pattern="yyyy-MM-dd HH:mm:ss" /></p>
    </li>
    <li>
		...
		<c:when test="${ !empty re }">
		 	...
		 	<tr>
		 		...
		 		<td width=20% style="word-break:break-all" >
		 			<fmt:formatDate value="${ r.regDate }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
...
<%-- 댓글작성창 --%>
<div class="w3-responsive w3-card-2 w3-rest">
	<form action="/conv/free/replyinsert">
      <input class="w3-input w3-hover-light-grey" name="content" type="text" placeholder="  댓글을 작성하세요...">
		<button class="w3-button w3-large w3-blue w3-right" style="font-weight:900; width:20%"
