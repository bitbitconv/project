...
<form action ="/conv/conv/post">   
   ...
   <div class="w3-card white w3-third">
    <div class="w3-container w3-theme">
      <h3>${post.title}</h3> 
        ...
        <div class="w3-container">
            ...
            <c:out value="${post.id}"/></h3>
         </div>
  <ul class="w3-ul w3-border-top">
    <li>
        <button class="w3-bar-item w3-button" name="no" value="<c:out value="${post.no}" />">
        <c:out value="${post.no}" />
        </button>
    </li>
       <li>
           <img width ="530" height="350" src="${pageContext.request.contextPath}${post.photo}"/>
           </li>
       <div class="w3-container">
         <p>  ${post.content}</p>
       </div> 
...
<div class="grid are-images-unloaded">
    <div class="w3-row-padding w3-third w3-margin-top">
     <div class="col-xs-6 col-md-4" width ="33%" float = "left" >
       ...
       <img width ="350" height="350" src ="${pageContext.request.contextPath}/conv${post.photo}"><br>
       </div>
     </div>
</div>
</div>
