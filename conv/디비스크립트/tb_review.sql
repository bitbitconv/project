...
values (s_review_no.nextval, 0, '제목1', 'effy', '내1', sysdate);

insert into t97_review (no, hit, title, writer, content, reg_date)
values (s_review_no.nextval, 0, '제목2', 'effy1', '내2', sysdate);

insert into t97_review (no, hit, title, writer, content, reg_date)
values (s_review_no.nextval, 0, '제목3', 'effy2', '내3', sysdate);
...
values (3, s_reply_no.nextval, 'effy', '내1', sysdate);

insert into t97_review_reply (t_no, no, writer, content, reg_date)
values (3, s_reply_no.nextval, 'effy1', '내2', sysdate);

insert into t97_review_reply (t_no, no, writer, content, reg_date)
values (4, s_reply_no.nextval, 'effy2', '내3', sysdate);
