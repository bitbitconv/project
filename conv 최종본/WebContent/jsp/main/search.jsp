...
<div class='w3-card-2 w3-container' style='min-height: 460px'>           
	...
	<div class='w3-card-2 w3-container' style='min-height: 460px'>           
		<h3>  <% int recipeint =0;%>                                                                
			<a href='/conv/com/conv/recipe/controller/recipelistcontroller' style="text-decoration: none;">혼밥 레시피</a>
		</h3>                                                                
		<br>                                                                 
		<div class='w3-responsive w3-card-4'>                                
			<table class='w3-table w3-striped w3-bordered'>                  
	...
	<div class='w3-card-2 w3-container' style='min-height: 460px'>           
		<h3> <% int worldint =0;%>                                                                 
			<a href='/conv/com/conv/recipe/controller/recipelistcontroller' style="text-decoration: none;">세계의 편의점</a>
		</h3>                                                                
		<br>                                                                 
		<div class='w3-responsive w3-card-4'>                                
			<table class='w3-table w3-striped w3-bordered'>                  
