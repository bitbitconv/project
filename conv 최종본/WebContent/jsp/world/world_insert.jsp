...
<div class="w3-container">
  ...
  <div class="w3-center">
    ...
    <p w3-class="w3-large">세계의 특이한 편의점!</p>
		...
		<form action="${pageContext.request.contextPath}/com/conv/world/controller/worldinsertcontroller "
			method="post" enctype="multipart/form-data">
			<div class="w3-section">
				<label>제목</label> <input class="w3-input" name="title" type="text"
					required>
			</div>
			<div class="w3-section">
				<label>내용</label>
			...
			window.onload = function() {
				...
				$("form").submit(
						function(e) {
							var messageLength = CKEDITOR.instances['content']
									.getData().replace(/<[^>]*>/gi, '').length;
							if (!messageLength) {
								e.preventDefault();
							}
						});
			...
			첨부파일1 : <input type="file" name="photo"><br>
			<div class="w3-center">
				<button type="submit"
